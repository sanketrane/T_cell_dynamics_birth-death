...
# model1: where lambda0 random effects in animals and N0 random effects in groups
## prediction points
tseq1 <- seq(14, 120, length.out = 100)
tseq2 <- seq(28, 120, length.out = 100)
tseq3 <- seq(42, 120, length.out = 100)
tseq4 <- seq(70, 120, length.out = 100)
tseq5 <- seq(189, 120, length.out = 100)
...
init_list <- function(){
  list(
    ...
    q_hostage   = exp(rnorm(1, log(0.01), 0.1)),
...
### compile model
ModelName <- "ASMplusHostAge_N0mouse"

 ...
 //spline 1
  ...
  real[] shm_ont(real t, real[] y, real[] parms, real[] rdata,  int[] idata) {
    ...
    // ki hi mN
    dydt[3] = rho_rte * mu * (y[1] + y[2]) + rho_nai * (2 * y[4] + y[3]) - (beta + delta_nai) * y[3];
    // ki lo mN
  ...
  real[] shm_chi(real time, real[] y, real[] parms, real[] rdata,  int[] idata) {
    ...
    // ki hi mN
    dydt[7] = (rho_rte * mu) * (y[5] + y[6]) + rho_nai * (2 * y[6] + y[7]) - (beta + delta_nai) * y[7];
    // ki lo mN
  ...
  real[] solve_chi(real solve_time,            // time point of observation
    ...
    vector math_reduce(vector global_params, vector local_params, real[] x_r, int[] x_i){
      ...
      if (dat_t0 == 1){
        ...
        ont_counts_mean = ont_solve[1] + ont_solve[2] + ont_solve[3] + ont_solve[4];
        ont_kiprop_mean = (ont_solve[1] + ont_solve[2])/ont_counts_mean;
...
generated quantities{
  ...
  for (i in 1:numPred){
    y1_mean_pred[i] = y_ont_pred[i, 1] + y_ont_pred[i, 2] + y_ont_pred[i, 3] + y_ont_pred[i, 4];
    y2_mean_pred[i] = (y_ont_pred[i, 1] + y_ont_pred[i, 3]) / y1_mean_pred[i];
    ...
    y5_mean_pred1[i] = (y_chi_pred1[i, 1] + y_chi_pred1[i, 3])/(y_chi_pred1[i, 1] + y_chi_pred1[i, 2] + y_chi_pred1[i, 3] + y_chi_pred1[i, 4]);
    y5_mean_pred2[i] = (y_chi_pred2[i, 1] + y_chi_pred2[i, 3])/(y_chi_pred2[i, 1] + y_chi_pred2[i, 2] + y_chi_pred2[i, 3] + y_chi_pred2[i, 4]);
    y5_mean_pred3[i] = (y_chi_pred3[i, 1] + y_chi_pred3[i, 3])/(y_chi_pred3[i, 1] + y_chi_pred3[i, 2] + y_chi_pred3[i, 3] + y_chi_pred3[i, 4]);

    y6_mean_pred1[i] = (y_chi_pred1[i, 5] + y_chi_pred1[i, 7])/(y_chi_pred1[i, 5] + y_chi_pred1[i, 6] + y_chi_pred1[i, 7] + y_chi_pred1[i, 8]);
    y6_mean_pred2[i] = (y_chi_pred2[i, 5] + y_chi_pred2[i, 7])/(y_chi_pred2[i, 5] + y_chi_pred2[i, 6] + y_chi_pred2[i, 7] + y_chi_pred2[i, 8]);
    y6_mean_pred3[i] = (y_chi_pred3[i, 5] + y_chi_pred3[i, 7])/(y_chi_pred3[i, 5] + y_chi_pred3[i, 6] + y_chi_pred3[i, 7] + y_chi_pred3[i, 8]);

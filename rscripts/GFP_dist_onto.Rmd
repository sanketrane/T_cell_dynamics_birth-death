...
#### Naive CD4 T cells $\delta$-varying age structured model:
...
At any host age, the lowest GFP intensity can be caculated using $\gamma$ such that $f_\text{min} = f_\text{max} * exp(-\gamma \, t).$
